  ...
  describe('fields', function() {
    ...
    describe('radio', function() {
        ...
        describe('validation', function() {
          ...
          describe('value', function() {
            ...
            it('should not be empty', function() {
              ...
              // when
              const input = screen.getByLabelText('Value', { selector: '#bio-properties-panel-Radio_1-values-staticValue-0-value' });
      ...
      describe('dynamic values', function() {
        ...
        it('source should be configurable', function() {
          ...
          // assume
          const input = screen.getByLabelText('Values source');

          expect(input.value).to.equal('static');

          // when
          fireEvent.input(input, { target: { value: 'input' } });
        ...
        it('input key should be configurable', function() {
        ...
        describe('validation', function() {
          ...
          describe('value', function() {
            ...
            it('should not be empty', function() {
              ...
              // when
              const input = screen.getByLabelText('Value', { selector: '#bio-properties-panel-Checklist_1-values-staticValue-0-value' });
        ...
        describe('validation', function() {
          ...
          describe('value', function() {
            ...
            it('should not be empty', function() {
              ...
              // when
              const input = screen.getByLabelText('Value', { selector: '#bio-properties-panel-Taglist_1-values-staticValue-0-value' });
        ...
        describe('validation', function() {
          ...
          describe('value', function() {
            ...
            it('should not be empty', function() {
              ...
              // when
              const input = screen.getByLabelText('Value', { selector: '#bio-properties-panel-Select_1-values-staticValue-0-value' });
